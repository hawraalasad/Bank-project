        ...
        <div className="spell-card">
          <div className="spell-card__inner">
            <div className="spell-card__shape">
              <div
                className="spell-card__trace"
                style="background-image: url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/accio.svg');"
              ></div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184 73.89">
                ...
                <path
                  ...
                  stroke-width="14"
                  className="cls-2"
                  d="M33,150s20-64,92-64,92,64,92,64"
        ...
        <div className="spell-card">
          <div className="spell-card__inner">
            <div className="spell-card__shape">
              <div
                className="spell-card__trace"
                style="background-image: url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/aguamenti.svg');"
              ></div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 201 117.05">
                ...
                <path
                  clip-path="url(#clip-aguamenti)"
                  className="trace-motion"
                  fill="none"
                  stroke="#ddfffb"
                  stroke-miterlimit="10"
                  stroke-width="14"
                  d="M21.14,141.53S25,181,60,181c0,0,15,1,32-17s36-46,39-54c0,0,25-34,40-34,0,0,29-15,48,21"
                  transform="translate(-21 -68.63)"
                />
              </svg>
            </div>
        ...
        <div className="spell-card">
          <div className="spell-card__inner">
            <div className="spell-card__shape">
              <div
                className="spell-card__trace"
                style="background-image: url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/arresto.svg');"
              ></div>

              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 166.02 168.22"
              >
                <clipPath id="clip-arresto">
                  <path
                    d="M40,210S66,77,73,70l46,130s3,12,8,0L171,73s35,129,34,132c0,0-3.13-35.18-10-74-7.1-40.13-17.95-83.95-19-85,0,0-4-7-8,0L123,190,78,48s-6-14-10,0S52,123,47,148C47,148,37,207,40,210Z"
                    transform="translate(-39 -41.78)"
                  />
                </clipPath>
                <polyline
                  clip-path="url(#clip-arresto)"
                  className="trace-motion"
                  fill="none"
                  stroke="#ddfffb"
                  stroke-miterlimit="10"
                  stroke-width="14"
                  points="0 168.22 33 7.22 83 159.22 133 7.22 151 84.22 166 163.22"
                />
              </svg>
            </div>
            <div class="spell-card__name">
              ...
              <p>
                Also known as the Slowing Charm. Slows down the velocity of an
                object
              </p>
            </div>
          </div>
        ...
        <div class="spell-card">
          <div class="spell-card__inner">
            <div class="spell-card__shape">
              <div
                className="spell-card__trace"
                style="background-image: url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/meteo.svg');"
              ></div>
        ...
        <div className="spell-card">
          <div className="spell-card__inner">
            <div className="spell-card__shape">
              <div
                className="spell-card__trace"
                style="background-image: url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/expecto.svg');"
              ></div>

              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 182.37 169.75"
              >
        ...
        <div className="spell-card">
          <div className="spell-card__inner">
            <div className="spell-card__shape">
              <div
                className="spell-card__trace"
                style="background-image: url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/567707/ridi.svg');"
              ></div>

              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 159.22 187.39"
              >
                ...
                <path
                  clip-path="url(#clip-ridi)"
                  className="trace-motion"
                  fill="none"
                  stroke="#ddfffb"
                  stroke-miterlimit="10"
                  stroke-width="10"
                  d="M207.22,33.9,123,120,54,45l3,85s-4,50,21,68,65,19,75,13c0,0,37.94-17.47,44.47-42.23"
                  transform="translate(-48 -32.61)"
                />
              </svg>
            </div>
            <div className="spell-card__name">
              <h5>Riddikkulus</h5>
              <p>
                Forces a Boggart to take the appearance of an object the caster
                is focusing on
              </p>
            </div>
          </div>
